...
..  _Scratch:   https://scratch.mit.edu/scratch_1.4/
...
Here is a reference guide on using Scratch:
    ...
    * :download:`ScratchReferenceGuide14.pdf`

Dev-C++
*******

This program, only available on Windows, is a complete development environment
to writing C++ programs. We will use this tool later in the course when we write
real programs. Most of these will be fairly simple.
...
..  warning::
    ...
    It will be important that you get the tools installed on the system you
    plan to use to complete this course as soon as possible. We will not use
    either tool right away, but it will be worthwhile to start getting set up
    right away That way, if you run into problems, we can deal with them before
    you really need them later.
